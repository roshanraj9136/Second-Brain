...
export default function Dashboard({ notes, user, onCreateNew, onSelectNote }: DashboardProps) {
  ...
  return (
    <div className="h-screen w-full bg-zinc-50 dark:bg-black p-8 overflow-y-auto flex flex-col relative selection:bg-purple-500/20">
      ...
      <div className="max-w-4xl w-full mx-auto mt-24 space-y-16 animate-in fade-in zoom-in-95 duration-1000 relative z-10">
        ...
        <div className="text-center space-y-8">
          ...
          <h1 className="text-7xl md:text-8xl font-black tracking-tight text-zinc-900 dark:text-zinc-100 drop-shadow-sm">
            {timeOfDay}, <br />
            <span className="text-zinc-300 dark:text-zinc-600">{userName}.</span>
          </h1>
          <p className="text-zinc-500 text-xl max-w-md mx-auto font-medium leading-relaxed">
        ...
        <div className="flex justify-center">
          <button 
            onClick={onCreateNew}
            className="group relative w-full max-w-xl h-72 rounded-[2.5rem] bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 shadow-2xl shadow-zinc-200/50 dark:shadow-black/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-500 cursor-pointer overflow-hidden flex flex-col items-center justify-center gap-8 ring-1 ring-zinc-900/5 dark:ring-white/10"
          >
            ...
            <div className="relative p-6 bg-zinc-50 dark:bg-zinc-800 rounded-3xl shadow-inner group-hover:bg-purple-50 dark:group-hover:bg-purple-900/20 transition-all duration-500 group-hover:rotate-12 group-hover:scale-110">
              <Plus className="w-12 h-12 text-zinc-900 dark:text-zinc-100 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-500" />
            </div>
            
            <div className="relative text-center space-y-2">
               <span className="block text-3xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">Create New Project</span>
               <span className="block text-base text-zinc-400 font-medium group-hover:translate-y-1 transition-transform">Start a blank page</span>
            </div>
          </button>
        </div>

        {recentNotes.length > 0 && (
          <div className="max-w-2xl mx-auto space-y-5 pt-12 animate-in slide-in-from-bottom-8 fade-in duration-1000 delay-200">
            ...
            <div className="grid gap-3">
              {recentNotes.map((note) => (
                <div 
                  ...
                  className="group flex items-center justify-between p-5 rounded-2xl bg-white dark:bg-zinc-900 border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800 hover:shadow-xl hover:shadow-zinc-200/20 dark:hover:shadow-black/20 cursor-pointer transition-all duration-300 hover:-translate-x-1"
                >
                  ...
                  <ArrowRight className="w-5 h-5 text-zinc-300 dark:text-zinc-700 opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 transition-all duration-300 ease-out" />
                </div>
              ))}
            </div>
          </div>
